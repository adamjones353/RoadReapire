...
namespace RoadRepairTests
{
    ...
    public class C_MultipleRepairTests
    {
        ...
        public void ThreeRepairs()
        {
            ...
            var road2 = new Road() { Length = 8, Width = 2, Potholes = 3 };
        ...
        public void LimitedMaterial()
        {
            ...
            var road3 = new Road() { Length = 8, Width = 2, Potholes = 3 };
            ...
            // Note that the available material (0.95) is less than the total volume (1.0) needed to fix all 3 roads in the previous test.
            var availableMaterial = 0.95;
            ...
            var materialUsed = plan.GetVolumeOfRepairs(roadsRepaired);
